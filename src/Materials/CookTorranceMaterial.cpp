...
void CookTorranceMaterial::imGuiRender(Shader& shader)
{
	...
	ImGui::DragFloat("Index of refraction", &m_refractionIndex, 0.001f, 0.0f, 10.0f);
...
void CookTorranceMaterial::setUniforms(Shader& shader)
{
	...
	shader.setFloat("u_material.refraction", m_refractionIndex);
